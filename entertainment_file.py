...
blackPanther = media.Movie("Black Panther",
                          "T'Challa, the King of Wakanda, rises to the throne in the isolated, technologically advanced African nation, but his claim is challenged by a vengeful outsider who was a childhood victim",
                          "https://upload.wikimedia.org/wikipedia/en/0/0c/Black_Panther_film_poster.jpg",
                          "https://www.youtube.com/watch?v=xjDjIWPwcPU")

# The movies array contains the different instantiated objects of the class Media 
movies = [toy_story,avatar,deadpool,transformer3 ,jumanji,blackPanther]

# Call the open_movies_page instance method passing the movies array argument to open the movies webpage
